...
function buildQuizResult(answers: QuizAnswers): QuizResult {
  ...
  if (answers.stage === "formal") {
    return {
      title: "وضعك سليم ومشروعك مرخص بالكامل",
      summary: "الآن تأكد إنك تستفيد من هذا الترخيص بأفضل طريقة.",
      status: "جاهزية ممتازة",
      steps: [
        "خطوتك الأولى حالياً هي تجديد رخصتك بوقتها، واستكشاف فرص العطاءات والدعم المتاحة لك.",
      ],
      nextTarget: "entities",
    };
  }
  ...
  if (answers.stage === "partial") {
    return {
      title: "قطعت نصف الطريق بتسجيل مشروعك",
      summary: "لكن لا يزال ناقصك الموافقة النهائية لتعمل براحة بال.",
      status: "استكمال الملف",
      steps: [
        "خطوتك الأولى هي استكمال استخراج رخصة المهن من البلدية أو الأمانة التابع لها موقعك.",
      ],
  ...
  if (answers.stage === "planning" && isHomeOnly) {
    return {
      title: "أنت في مرحلة التخطيط ومشروعك من المنزل",
      summary: "وهذا أفضل وقت ترتّب فيه مشروعك قبل ما يكبر.",
      status: "تخطيط أولي",
      steps: [
        "خطوتك الأولى هي التأكد إذا كان نشاطك يمكن ترخيصه من المنزل أم لا.",
      ],
  ...
  if (answers.stage === "planning") {
    return {
      title: "عندك موقع تجاري في الخطة لكن لم تفتتح رسمياً بعد",
      summary: "هذا الوقت مناسب لإنهاء الإجراءات قبل الانطلاق.",
      status: "بداية محسوبة",
      steps: ["خطوتك الأولى هي الاستفسار عن متطلبات الموقع التجاري من البلدية."],
      nextTarget: hasPartners ? "legal-forms" : "entities",
    };
  }
  ...
  return {
    ...
    summary: "وهذا الفراغ بقلقك حتى لو ما بيظهر.",
    status: "ترخيص تدريجي",
