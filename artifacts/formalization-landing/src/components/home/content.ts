...
export const SOURCE_FACTS = [
  ...
  },
  {
    ...
    decimals: 0,
    suffix: "%",
    title: "من المنشآت كانت صغيرة ومتوسطة ومتناهية الصغر",
    description: "مرجع اقتصادي منشور يوضح الوزن العددي للمشاريع الصغيرة والمتوسطة ومتناهية الصغر في السوق الأردني.",
    year: "مرجع 2016",
